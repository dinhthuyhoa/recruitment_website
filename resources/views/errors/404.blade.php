@if (request()->is('admin/*'))
    ...
    <head>
        ...
        <title>Error - Pages | Recruitment</title>
        ...
        <!-- Page CSS -->
        <!-- Page -->
        <link rel="stylesheet" href="{{ asset('admin_template/assets/vendor/css/pages/page-misc.css') }}" />
        <!-- Helpers -->
    ...
    <body>
        ...
        <div class="container-xxl container-p-y">
            <div class="misc-wrapper">
                ...
                <div class="mt-3">
                    <img src="{{ asset('admin_template/assets/img/illustrations/page-misc-error-light.png') }}"
