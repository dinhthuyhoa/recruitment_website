...
<!-- Vendors JS -->
<script src="{{ asset('admin_template/assets/vendor/libs/apex-charts/apexcharts.js') }}"></script>
...
<script src="{{ asset('admin_template/assets/js/pages-account-settings-account.js') }}"></script>
